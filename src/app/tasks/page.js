...
export default function Tasks() {
  ...
  //{"id": 1}
  async function completaTarea(idActualizar, completedAct) {
    const response = await fetch("api/tasks", {
      method: "PUT",
      headers: { "Content-Type": "application-json" },
      body: JSON.stringify({ id: idActualizar, completed: completedAct }),
    });
